 ...
 *
 * Other sources:  [FILL IN per rubric - be specific and give URLs.
 *                 Example: "Initial draft generated by Claude
 *                 (claude.ai) in response to a prompt describing this
 *                 assignment's requirements, then hand-modified by
 *                 [Your Name] -- see inline block comments below for
 *                 which sections were changed."
 *                 If you also used ChatGPT/Copilot output as part of
 *                 this final file, name them here too with how you
 *                 accessed them, matching your GenAI analysis PDF.]
 *
